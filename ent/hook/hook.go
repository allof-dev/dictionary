...
// The LemmaFunc type is an adapter to allow the use of ordinary
// function as Lemma mutator.
type LemmaFunc func(context.Context, *ent.LemmaMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LemmaFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LemmaMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LemmaMutation", m)
}

// The SenseFunc type is an adapter to allow the use of ordinary
// function as Sense mutator.
type SenseFunc func(context.Context, *ent.SenseMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SenseFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SenseMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f SynsetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SynsetMutation); ok {
		return f(ctx, mv)
	}
